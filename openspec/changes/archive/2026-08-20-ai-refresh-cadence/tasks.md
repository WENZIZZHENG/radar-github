...
- [x] 4.1 k3 独立评审，中/高 findings 清零（最多三轮）（2026-08-20 收口：F2×1 已修——三条守卫测试空转改窗口日断言；F3×4 随补丁带入）
- [x] 4.2 A 级预演（真实/模拟环境验证窗口日/非窗口日行为）+ 复验步骤卡 → 本人走查（2026-08-20 本人拍板：本次免复验步骤卡、AI 自测跑绿即可——verify.ps1 413 passed 一次跑绿；2026-08-20 部署生产冒烟通过：回环 6 端点全 200、公网 401 正常）
- [x] 4.3 通过后归档 OpenSpec change（由主 agent 收口统一处理，本次不 commit）
